...
import ir.vasl.navigationcomponentimpl.databinding.ActivityLocationDetailsBinding;
...
public class LocationDetailsActivity extends BaseActivity implements MyCustomViewCallBack, GlobalListCallback {
    ...
    private void extractExtra() {
        ...
        LocationModel.Result result = (LocationModel.Result) getIntent().getExtras().getSerializable(PublicValues.KEY_EXTRA_DATA);
    ...
    public void onItemClicked(Object object) {
        if (object instanceof CharacterModel.Result) {
            Intent intent = new Intent(LocationDetailsActivity.this, CharacterDetailActivity.class);
